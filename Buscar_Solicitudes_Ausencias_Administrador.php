...
<div class="Contenido">
    ...
    <?php
        ...
        if(empty($Buscador)){
            header('Location: Solicitudes_Ausencias_Admin.php');
        }
    ?>    
