    ...
    $(function() {
        ...
        $('#datepicker1').datepicker({
            ...
            onSelect: function(fecha) {
                ...
                $.ajax({
                        url: 'subir_archivo_solicitud.php',
                        type: 'POST',
                        data: {
                            fecha: fecha
                        },
...
<div class="body_solicitud">
    <section class="izquierdo_solicitud">
        ...
        <a class="button_izquierdo" href="Solicitud_Empleado.php"> Realizar solicitud </a>
    </section>
    <section class="derecho_solicitud">
        <form id="form_subir" enctype="multipart/form-data" action="subir_archivo_solicitud.php" method="POST" class="form_solicitud">
            ...
            <div class="division_from_solicitud">
                ...
                <input type="file" name="archivo" id="archivo" class="form_derecha file_input" />
            </div>
